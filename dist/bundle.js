...
/***/ function(module, exports, __webpack_require__) {
	...
	_router2['default'].run(function (Handler, state) {
	  return _react2['default'].render(_react2['default'].createElement(Handler, state), rootEl);
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var location = process.env.NODE_ENV === 'production' ? _reactRouter.HashLocation : _reactRouter.HistoryLocation;
	
	exports['default'] = (0, _reactRouter.create)({ routes: _routes2['default'], location: location });
